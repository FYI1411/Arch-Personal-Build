...
alias service='systemctl enable --now $(cat ~/installs/services.txt)'
alias install='driver && package && aur_packages && service'
...
alias gs='git status'
alias gd='git diff'
alias gi='git rm -r --cached . && git add . && git commit -m "Remove ignored files (with gi alias)"'
